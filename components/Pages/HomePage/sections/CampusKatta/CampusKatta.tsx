...
const CampusKatta = () => {
  ...
  const { campusKatta: configuration } = config;
      ...
      >
        <div className="wrapper flex flex-col gap-[4rem] py-[4rem]">
          ...
          <div className="grid grid-cols-12 gap-[2rem]">
            {configuration?.gallery?.images?.map((img, i) => {
              const imgOneClass =
                "col-span-4 row-span-2 1200:row-span-1 1200:col-span-6 900:!col-span-12 h-[82rem] 1200:h-[40rem] object-responsive";
              const imgTwoClass =
